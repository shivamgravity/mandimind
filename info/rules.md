...
1. COMPETITION TITLE
Build with Gemma: TFUG Prayagraj [AI Prayagraj]
...
https://www.kaggle.com/competitions/build-with-gemma-tfug-prayagraj-ai-prayagraj

5. TOTAL PRIZES AVAILABLE: $[INSERT]
First Prize: $1000 Second Prize: $600 Third Prize: $400
...
Build an AI application powered by Gemma 4 that solves a real-world problem according to the tracks.
...
Gemma Integration (30%) Innovation & Impact (30%) Functionality (20%) Presentation & Writeup (20%)

Projects that do not make meaningful use of Gemma as a core component of the solution may be disqualified from judging.

1. TEAM LIMITS
a. The maximum Team size is five (5). b. Team mergers are not allowed.
...
a. Competition Timeline dates (including Entry Deadline, Final Submission Deadline, ) are reflected on the competition’s Overview > Timeline page.
...
PRIZE DISTRIBUTION
All prizes will be distributed via Payoneer. Winners under the age of 18 must submit a signed parental/guardian approval form before any prize can be released.
...
GitHub Repository Kaggle Notebook Kaggle Project Write-up README Demo Video (maximum 3 minutes) Working Prototype or Live Demonstration
